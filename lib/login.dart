...
import 'package:eduapp/mainhome.dart';
...
class _LOGINState extends State<LOGIN> {
  ...
  final color3 = const Color(0xFF18BF68);
        ...
        child: Column(
          ...
          Container(
            ...
            child: Container(
                ...
                constraints:
                    BoxConstraints(minWidth: 80, minHeight: 40, maxWidth: 260),
                child: Row(
                  children: [
                    Icon(Icons.email),
                    SizedBox(width: 10),
          ...
          Container(
            // width: 120,
            padding:
                const EdgeInsets.only(left: 30, top: 7, right: 7, bottom: 7),
  ...
  Widget build(BuildContext context) {
    const color3 = const Color(0xFF1A237E);
    return Form(
        key: _formKey,
        child: MaterialApp(
